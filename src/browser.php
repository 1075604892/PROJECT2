    ...
    <ul>
        ...
        <div class="hot">
            ...
            while($row = $result->fetch_assoc()){
                ...
                echo '<a href="browser.php?hotcountry='.$row1['Country_RegionName'].'"><li><button>'.$row1['Country_RegionName'].'</button></li></a>';
            }
            ?>
        </div>
        <li>热门城市</li>
        ...
        for($i=0;$i<4;$i++){
            ...
            echo '<a href="browser.php?hotcity='.$row1['AsciiName'].'"><li><button>'.$row1['AsciiName'].'</button></li></a>';}else{
                $i--;
            }
        }
        ?>
            ...
            for($i=0;$i<4;$i++){
                ...
                if(!empty($row['Content'])){
                    echo '<a href="browser.php?hotcontent='.$row['Content'].'"><li><button>'.$row['Content'].'</button></li></a>';}
            }
        ?>
            </div>
    </ul>
