    ...
    else
    {
        ...
        else
        {
            ...
            if(!empty($_POST['description'])){
                ...
                $sqlUP = "INSERT INTO `travelimage`(`Title`, `Description`, `CityCode`, `Country_RegionCodeISO`, `UID`, `PATH`, `Content`) VALUES ('".$title."','".$description."','".$cityCode."','".$country_RegionCodeISO."','".$UID."','".$PATH."','".$content."')";
                $queryUP = mysqli_query($conn,$sqlUP);
            }else{
                $description = $_POST['description'];
                $sqlUP = "INSERT INTO `travelimage`(`Title`, `CityCode`, `Country_RegionCodeISO`, `UID`, `PATH`, `Content`) VALUES ('".$title."','".$cityCode."','".$country_RegionCodeISO."','".$UID."','".$PATH."','".$content."')";
                $queryUP = mysqli_query($conn,$sqlUP);
            }
